...
Below are instructions to get you setup with `git` on the ARM
...
Go to https://jupyterhub.arm.gov. See also our [JupyterHub documentation](jupyterhub.md)

### 2. Open a Terminal
Choose the 'Terminal' from the 'Other' options in the 'Launcher' tab.

![jupyterlab](../../images/jupyter-terminal.png)
...
the ARM Github organization via the command line.
